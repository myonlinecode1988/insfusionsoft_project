...
def get_table():
   #select a table with table name 'table_x'
...
def add_vals_to_cols(colnames):
    ...
    for elem in colnames:
        #selecting dummy data from 0-1000
        out_dic[elem]=randint(0,100)
    return out_dic

def get_random_colnames(colnames):
    #Algo:1)shuffle the colnames 
...
def publish_messages(project, topic_name):
    """Emits messages  to a Pub/Sub topic according to specifications"""
